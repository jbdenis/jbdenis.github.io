#!/usr/bin/perl -w
#
# 19_03_03 19_03_04 19_03_05 19_09_19 19_11_14
#
...
my $test2 = ['Le 2019_03_04, il a bien fallu voir que Paul & Pierre étaient amis \!\!',
	     'Les charactères spéciaux de Latex sont :   & % $ # _ { } ~ ^ \ ',
             ...
             'On change de page \newpage',
             'La page a-t-elle été changée ?'];
my $test3 = ['Ici, je fais un paragraphe (espace horizontal \quad\quad) qui comprend (espace vertical \medskip\medskip) des sauts de lignes\newlinequi doivent \newlineêtre \newline respectés \newline !!! Là',
