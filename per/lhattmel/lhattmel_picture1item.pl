#!/usr/bin/perl -w
#
# 18_02_10 18_02_11 18_04_11 18_10_03 19_01_21
#
use strict;
use warnings;
...
my $imaun = [ {fil=>"pa01.jpg",hei=>"8cm",wha=>"nwh"} ];
my $ima00 = [
              {fil=>"pa01.jpg",cap=>["hei=4cm"],hei=>"4cm",wha=>"nwhd"},
              {fil=>"po01.jpg",cap=>["hei=4cm"],hei=>"4cm",wha=>"nwh"},
              {fil=>"pa01r.jpg",cap=>["hei=4cm"],hei=>"4cm",wha=>"nwh"},
              {fil=>"po01r.jpg",cap=>["hei=4cm"],hei=>"4cm",wha=>"nwh"},
           ];
my $ima000 = [
              {fil=>"pa01.jpg",cap=>["wid=4cm"],wid=>"4cm",wha=>"nwh"},
              {fil=>"po01.jpg",cap=>["wid=4cm"],wid=>"4cm",wha=>"nwh"},
              {fil=>"pa01r.jpg",cap=>["wid=4cm"],wid=>"4cm",wha=>"nwh"},
              {fil=>"po01r.jpg",cap=>["wid=4cm"],wid=>"4cm",wha=>"nwh"},
           ];
my $ima0 = [
...
foreach my $ti ("h","l") {
    ...
    $reun = &lhattmel::picture1item(ima=>$imaun,dim=>[1,1],opt=>"Hn");
    $re000 = &lhattmel::picture1item(ima=>$ima000,dim=>[2,2],opt=>"X");
    $re00 = &lhattmel::picture1item(ima=>$ima00,dim=>[2,2]);
    $re0 = &lhattmel::picture1item(ima=>$ima0,dim=>[2,2]);
    $ri0 = &lhattmel::picture1item(ima=>$ima3,dim=>[1,2],
			      cca=>$ccb,typ=>$ti,opt=>"c",typ=>$ti);
    $ri1 = &lhattmel::picture1item(ima=>$ima1,dim=>[2,2],
			      cca=>$cca,typ=>$ti,opt=>"c",typ=>$ti);
    #&uie::print8structure(str=>$ri1); &uie::pause();
    my $vopt = "b";
    $ri21 = &lhattmel::picture1item(ima=>$ima2,dim=>[2,2],pla=>$pla2,typ=>$ti,cca=>["premier",$vopt],
                              opt=>$vopt,typ=>$ti);
    $vopt = "c";
    $ri22 = &lhattmel::picture1item(ima=>$ima2,dim=>[2,2],pla=>$pla2,typ=>$ti,cca=>["deux","second",$vopt],
                              opt=>$vopt,typ=>$ti);
    $vopt = "i";
    $ri23 = &lhattmel::picture1item(ima=>$ima2,dim=>[2,2],pla=>$pla2,typ=>$ti,cca=>["troisieme",$vopt],
                              opt=>$vopt,typ=>$ti);
    $vopt = "l";
    $ri24 = &lhattmel::picture1item(ima=>$ima2,dim=>[2,2],pla=>$pla2,typ=>$ti,cca=>["quatrieme",$vopt],
                              opt=>$vopt,typ=>$ti);
    $ri3 = &lhattmel::picture1item(ima=>[{fil=>"i42.jpg",cap=>["Lampe portrait"],rot=>-90,hei=>"4cm"}],
